...
class ChatDialogs {
            ...
            content: Column(
              ...
              children: [
                TextField(
                  ...
                  autofocus: true,
                  onSubmitted:
                      (value) => _handleRenameSubmit(context, chat, value),
                ),
              ],
            ),
            actions: [
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Text(
              ...
              style: GoogleFonts.inter(color: Colors.grey[300], fontSize: 18),
            ),
            actions: [
              _buildCancelButton(context),
              TextButton(
  ...
  // FIXED: Handle create chat with proper navigation
  static void _handleCreateChat(
    ...
    // Create the chat (it will automatically switch to it)
    ...
    // Navigate to chat page - the cubit has already switched to the new chat
    Navigator.push(
      context,
